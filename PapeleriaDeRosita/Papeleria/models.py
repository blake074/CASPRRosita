...
class Factura(models.Model):
    ...
    DESC_FACTURA=models.DecimalField(max_digits=3, decimal_places=2, verbose_name="Descuento en la factura",null=False);
    IVA_FACTURA=models.DecimalField(max_digits=3, decimal_places=2, verbose_name="IVA en la factura",null=False);
    SALDO_FACTURA=models.IntegerField(verbose_name="Saldo de la factura",null=False, validators=[
            MinValueValidator(limit_value=0, message="La cantidad no puede ser negativa.")
        ]);
